...
# int() ile string'i tam sayıya çevirebiliriz.'
number2=int(number2)
print("integer: ", type(number2))

# float() ile string'i virgüllü sayıya çevirebiliriz.'
number2=float(number2)
print("float:\t ", type(number2))
...
number1 = 44
# Buradaki number1=44 olan ver artık bir çöptür çünkü alt satıda aynı isimle başka bir veri vardır
number1 = 23
